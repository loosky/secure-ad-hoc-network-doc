...
\acro{Asymmetric Link}
	...
	send packets to another node, the link in between them is called an asymmetric
	link.
...
\acro{Congestion}
	Congestion is a state in which the the amount of traffic on a network surpasses
...
\acro{Proxy Certificate} 
	...
	to which the recipient can act on behalf of the issuer.
