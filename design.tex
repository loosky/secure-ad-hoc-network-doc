...
Before issuing the \ac{PC1} the \ac{SP} also has to verify the public key
...
because with an easily verifyable certificate for all trusted nodes in the
network all nodes can continue to verify each other even if the SP is
unavailible. This is where the \aclp{PC} comes in handy, while regular \acp{EEC}
