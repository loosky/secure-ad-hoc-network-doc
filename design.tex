...
%signature in its routing messages. The signature excerpt is just a value used
%in the following routing messages, and not the cryptographic signature itself,
