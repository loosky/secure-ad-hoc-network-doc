...
\usepackage{graphicx,subfig,acronym,fancyhdr,listings,longtable,verbatim,enumerate,courier,caption,tabularx,pdfpages,lmodern}
...
\input{appendix_test_results}

\pagestyle{empty}
\cleardoublepage
\pagestyle{fancy}

\input{appendix_paper}
